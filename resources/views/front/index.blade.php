...
<head>
  ...
  <title> @yield('tittle', 'Tú Guía') </title>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body id="page-top" class="index">
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top">Tú Guía</a>
                     <img src="{{ asset('img/logo.png') }}" alt="Tu Guia" width="40">
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="#contact">Registrate Gratis</a>
                        </li>
                        <li>
        ...
        <header>
            <div class="container">
                <form class="" role="search" method="GET" action="{{  route('company.index')  }}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Haz que tú amigos o clientes te encuentren mas facil.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; Tú Guía 2017</span>
            </div>
            <div class="col-md-4">
